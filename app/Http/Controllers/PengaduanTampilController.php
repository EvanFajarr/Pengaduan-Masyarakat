...
class PengaduanTampilController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pengaduanTampil.index',['pengaduan'=>$pengaduan, 'tanggapans' => $tanggapan]);
    }
    ...
    {
        $data_foto = pengaduan::where('id', $id)->first();
